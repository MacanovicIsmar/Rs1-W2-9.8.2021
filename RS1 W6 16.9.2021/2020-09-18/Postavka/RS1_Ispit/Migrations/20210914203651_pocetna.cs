    ...
    public partial class pocetna : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TakimicenjeUcesnik", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TakimicenjeUcesnik_OdjeljenjeStavka_OdjeljenjeStavkaId",
                        column: x => x.OdjeljenjeStavkaId,
                        principalTable: "OdjeljenjeStavka",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TakimicenjeUcesnik_Takmicenje_TakmicenjeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TakimicenjeUcesnik_OdjeljenjeStavkaId",
                table: "TakimicenjeUcesnik",
                column: "OdjeljenjeStavkaId");

            migrationBuilder.CreateIndex(
                name: "IX_TakimicenjeUcesnik_TakmicenjeId",
                table: "TakimicenjeUcesnik",
                column: "TakmicenjeId");
